...
@Composable
fun AppTheme(
    darkThemeUpdate:Boolean,
    content: @Composable() () -> Unit
) {
  val d = darkThemeUpdate
  val darkTheme: String = SharedPrefsHelper(LocalContext.current).getTheme(isSystemInDarkTheme())
  val colorScheme = when(darkTheme) {
      ThemesTypes.DARK  -> darkScheme
      ThemesTypes.LIGHT -> lightScheme
